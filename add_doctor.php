            ...
            <div class="form-inner-cont">
              <form action="" method="post" class="" style="width: 600px; " enctype="multipart/form-data">
                <div class="form-top-left">
                  ...
                  <input type="text" name="speciality" id="w3lSender" placeholder="Speciality" required="">
...
">
                ...
                <div class="form-top-righ">
                  <textarea name="doc_description" id="w31Address" placeholder="Description (optional)" required=""></textarea>
                </div>
