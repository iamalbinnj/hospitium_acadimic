            ...
            <div class="form-inner-cont">
              <form action="" method="post" class="" style="width: 600px; ">
                <div class="form-top-left">
                  ...
                  <input class="label_text " type="text" name="name" id="w3lName" placeholder=" Full Name" required="">

                  <input type="email" name="email" id="w3lSender" placeholder="Email" required="">
                  
                  <input type="password" name="password" id="w3lpassword" class="password" placeholder="Password" required="">
                  

                  <input type="text" name="phone" id="w3lName" placeholder="Phone Number" required="">
...
">
                ...
                <div class="form-top-righ">
                  <textarea name="address" id="w31Address" placeholder="Address" required=""></textarea>
                </div>
                <div class="join-now">Already Registered? <a href="login.php" class="btn__tertiary--medium" id="join_now" data-litms-control-urn="login_join_now" data-cie-control-urn="join-now-btn">Login now</a></div><br>
