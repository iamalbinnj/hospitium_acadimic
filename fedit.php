...
if(isset($_GET['fl_id']))
  {
    ...
    $w="SELECT * FROM faculty WHERE fl_id=$fl_id";
// var_dump($w);
...
if(isset($_POST['submit']))
{
  ...
  $qu="UPDATE faculty SET f_name='$name',f_dob='$dob',f_gender='$gender',f_phone='$phone',f_email='$email',f_address='$address' where fl_id=$fl_id";
  //var_dump($qu);
 ...
 $result1=$con->query($qu);
  ...
  //echo "<script>window.location.replace('viewsubjecten.php');</script>";
     ...
     echo "<script>
    window.location.replace('facultyprofile.php')
    </script>";  
...
?>
  <section class="w3l-contact-11 pt-5">
            ...
            <center><div class="form-inner-cont">
              <form action="" method="post" class="" style="width: 600px; ">
                <div class="form-top-left">
                  ...
                  <input type="text" name="name" id="w3lName" placeholder=" Full Name" value="<?php echo $result['f_name'];?>" required="">
                  <input type="email" name="email" id="w3lSender" placeholder="Email" value="<?php echo $result['f_email'];?>"
                    required="">
                  <!-- <input type="password" name="password" id="w3lpassword" placeholder="Password" required=""> -->
                  

                
                  <input type="text" name="phone" id="w3lName" placeholder="Phone Number" value="<?php echo $result['f_phone'];?>"
                    required="">
                    <input type="date" name="dob" placeholder="Date of birth" value="<?php echo $result['f_dob'];?>">
    ...
    border-radius: 8px;
">
                    	<option value="<?php echo $result['f_gender'];?>"><?php echo $result['f_gender'];?></option>
                ...
                <div class="form-top-righ">
                  <textarea name="address" id="w31Address" placeholder="Address"
                    required=""><?php echo $result['f_address'];?></textarea>
                </div>
